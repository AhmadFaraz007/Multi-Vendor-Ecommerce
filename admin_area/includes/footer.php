	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Bismillah Town, Burewala, Punjab, Pakistan.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0123456789">0312-3456789</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@yourwebsite.com" class="email__addr">AvenueFashion@yourwebsite.com</a>
				</div>
			</div>
	...
	<div class="banners">
		<div class="container clearfix">
			...
			<div class="banner-award">
				<span>Award winner</span><br> Fashion awards 2025
			</div>
